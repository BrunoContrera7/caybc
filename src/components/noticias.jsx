    ...
    <section id="noticias" className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
            <Badge className="mb-4 bg-primary">Últimas Noticias</Badge>
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-balance">Resultados de la Semana</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-balance leading-relaxed">
              Mantente al día con todas las novedades deportivas y eventos del club
            </p>
          </div>
